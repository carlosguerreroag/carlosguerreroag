...
<div style="display: flex; gap: 10px;">
  <img src="https://miro.medium.com/v2/resize:fit:618/format:webp/1*jzynk2dcrRxKfoSnvQcmqg.png" alt="eJPT" width="175"/>
  <img src="https://img-c.udemycdn.com/open-badges/v2/badge-class/1836431138/image771495085737125892.png" alt="AWS CCP" width="150"/>
</div>
...
My journey is a continuous evolution of actively deepening my skills in cloud infrastructure, automation, scripting, and DevSecOps practices.
I strive to stay ahead of the curve, constantly learning, improving and seeking new challenges that allow me to develop both personally and professionally.

If you're interested in sharing ideas, projects, or opportunities in the Operations/Cybersecurity field, feel free to get in touch. 
